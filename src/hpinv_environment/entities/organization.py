...
class Organization:
    ...
    def __init__(self,
        ...
        self.children_hierarchy = {ultimate_parent_worksite_id: dict()}
    ...
    def add_child(self, child_worksite_id: int, parent_worksite_id: int):
        ...
        if child_worksite_id in parent_dict:
            raise KeyError(f"Child worksite {child_worksite_id} already exists in Parent worksite "
                           f"{parent_worksite_id} dict.")
